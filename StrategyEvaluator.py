...
class StrategyEvaluator:
    ...
    def __init__(self, strategy_function,
                 strategy_settings: dict = {'indicators': ['low_boll', 'fast_sma', 'slow_sma']}):
    ...
    def printResults(self):
        ...
        if len(self.profits_list) > 0:
            profitability = Decimal(100.0) * (
                        self.complete_resulting_balance / self.complete_starting_balance - Decimal(1.0))
